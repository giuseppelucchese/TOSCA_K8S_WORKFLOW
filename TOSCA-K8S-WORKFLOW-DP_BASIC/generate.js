...
function createScriptTask(process, id, name, code) {
	...
	let op = name.substr(0,name.length-2);
	let taskname = 'task-' + name.substr(name.length-1,name.length);
	if(op == 'create_task') inputParameterUrl.setText('http://127.0.0.1:5000/create_task?taskname='+taskname)
	if(op == 'check_task')  inputParameterUrl.setText('http://127.0.0.1:5000/check_task?taskname='+taskname)
	if(op == 'delete_task') inputParameterUrl.setText('http://127.0.0.1:5000/delete_task?taskname='+taskname)
